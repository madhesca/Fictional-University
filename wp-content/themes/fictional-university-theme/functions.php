...
//adding author to search results
...
function university_files() {
	//pull in google map scripts
	wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyBlJPQwA65t74vJ7o9QZeMpNdpvxWW-H1s', NULL, microtime(), true);
	//pull in javascripts
	wp_enqueue_script('main-university-js', get_theme_file_uri('/js/scripts-bundled.js'),  NULL, microtime(), true);
	wp_enqueue_style('custom-google-fonts', '//fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i|Roboto:100,300,400,400i,700,700i');
	wp_enqueue_style('font-awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
	wp_enqueue_style('university_main_styles', get_stylesheet_uri(), NULL, microtime());
	//makes url flexible for JSON to load in search.js
...
function universityMapKey($api) {
	$api['key'] = AIzaSyBlJPQwA65t74vJ7o9QZeMpNdpvxWW-H1s;
	return $api;
}
